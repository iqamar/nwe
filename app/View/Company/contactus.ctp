...
<div class="maincontent">
    ...
    <div class="margintop20">
        <div class="contactlft">
            <?php echo $this->Form->create(null, array('url' => '/the-company/contactus/', 'name' => 'myform', 'id' => 'myform', 'class' => 'formstyle', 'onsubmit' => 'return validateForm();')); ?>
            <fieldset>
