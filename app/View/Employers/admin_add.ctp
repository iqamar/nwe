...
<div class="row-fluid sortable">
	...
	<div class="box-header well" data-original-title>
	    <h2><i class="icon-edit"></i> Add New Employer</h2>
	    <div class="box-icon">
	...
	<div class="box-content"><br/>
		...
		<fieldset>
			...
			<div class="controls">
			    <input class="input-xlarge focused" id="selectComapny" name="selectComapny" type="text" value="">
			</div>
		    </div>
		...
		<div class="control-group">
			...
			<div class="controls">
			    <input class="input-xlarge" id="featured_employer" name="featured_employer" type="checkbox" value="1">
			</div>
		    </div>
