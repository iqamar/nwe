...
<div class="row-fluid sortable">
	...
	<div class="box-content"><br/>
		...
		<fieldset>
			...
			<div class="controls">
			    <input class="input-xlarge focused" id="selectComapny" name="articleName" type="text" value="">
			</div>
		    </div>
			...
			<div class="controls">
			    <textarea id="address" name="shortDescription" rows="3"></textarea>
			</div>
		    </div>
			...
			<div class="controls">
			    <textarea class="cleditor" id="address" name="articlePost" rows="3"></textarea>
			</div>
		    </div>
