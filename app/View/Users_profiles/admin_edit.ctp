...
<div class="users form">
	...
	<?php echo $this->AlaxosForm->input('id'); ?>
 	...
 	<h2><?php echo ___('admin edit user'); ?></h2>
	...
	<tr>
		...
		<td>:</td>
		<td>
			<?php echo $this->AlaxosForm->input('firstname', array('label' => false, 'value' => $user['firstname'])); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>:</td>
		<td>
			<?php echo $this->AlaxosForm->input('lastname', array('label' => false, 'value' => $user['lastname'])); ?>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td>
			<?php echo ___('last login') ?>
		</td>
		<td>:</td>
		<td>
			<?php echo $this->AlaxosForm->input('last_login', array('label' => false)); ?>
		</td>
	</tr>
	<tr>
		<td>
