...
<?php $arr = $this->params['pass']; 
        	...
        	<div class="profile-topcontent">
             ...
             <?php  $i =1; 
              ...
              <li>
                ...
                <a href="/users_profiles/update/" class="button" style="float:right;">Edit Profile</a>
    ...
    <div class="clear"></div>
     ...
     <!-- Activities start -->
              ...
              <ul>
				  ...
				  if ($year_diff>=1) { echo $year_diff." Years";} else if ($month_diff < 12) { echo $month_diff." months";}
         ...
         <?php if ($starsign__Row['Star_sign']['id'] != '') {

				$id = $starsign__Row['Star_sign']['id'];

			?>

          <a href="javascript:showStarSign('<?php echo $id?>','<?php echo $uid?>','starsign')" class="poplight">
          ...
          <div style="display:none;">
			...
			<div style="opacity: 1; width: 301px; height: 125px; top: auto; left: auto; position: absolute;" class="mcTooltipInner">
					...
					<div class="userlikes">
						...
						<div class="userlikes-rgt">
							...
							<ul>
								...
								<li class="justify-text"><?php echo substr($starsign__Row['Star_sign']['todays_horoscope'],0,100);?></li>

                                <li>

                              		<a class="poplight" href="javascript:showStarSign('<?php echo $id;?>','<?php echo $uid;?>')">

                              			<strong>See Full Horoscope</strong>
			...
			<ul>
				...
				<li class="has-sub"> 
					...
					<ul>
						...
						<li><a href="<?php echo NETWORKWE_URL;?>/news/userarticles/"><div class="icon-articles"></div>Articles</a></li>
					</ul>
  ...
  <div id="morebttns-div">

    <a id="emailbttn" href="<?php echo NETWORKWE_URL;?>/messages/">InMails <span class="redcolor"></span></a>

    <a id="importconbttn" href="<?php echo NETWORKWE_URL;?>/contacts/">Import Contacts</a>

    <a id="horoscopebttn" href="javascript:showStarSign('<?php echo $id?>','<?php echo $uid?>','dailysign')" class="poplight">Daily Horoscope</a>
	<a id="chatbttn" href="#" onclick="showChat(this);" value="1">Chat With Your Connections</a>
  </div>
...
<div class="profile-box">
        ...
        <div class="profile-box-content experience">
            ...
            <ul>
                ...
                <li>
                    <?php 
                    if ($totalExp['users_experiences']['start_date'] != '0000-00-00' || $totalExp['users_experiences']['end_date'] != '0000-00-00'){
                        echo $totalExp['users_experiences']['start_date']." to ".$totalExp['users_experiences']['end_date'];
                    }?>  
                    <?php echo $totalExp['users_experiences']['location'] ? ' - '.$totalExp['users_experiences']['location'] : ''; ?>
                </li>
...
<div class="profile-box">
 ...
 <div class="profile-box">
   ...
   <?php }?>
	...
	<div class="more"><?php echo $this->Html->link('More...',array('controller'=>'companies','action'=>'index'),array('style'=>''));?></div>
		  ...
		  <div class="wholike-rgt">
			  ...
			  <ul>
				  ...
				  <li>
                      ...
                      <input name="Connect" type="button" id="Connect" value="Following" class="red-bttn" onclick="followers('<?php echo $follow_id;?>','0','<?php echo $following_id;?>','<?php echo $user_id;?>','following')"></div>
