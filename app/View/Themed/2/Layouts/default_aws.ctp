...
<html lang="en">
                ...
                <div class="container-fluid">
                    ...
                    <div class="btn-group pull-right" >
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo NETWORKWE_URL?>/recruiter/employerEdit/<?= $this->Session->read('company_id'); ?>">Profile</a></li>
                            <li class="divider"></li>
 ...
 <?php //echo $this->element('sql_dump'); ?>
            <footer>
                <p class="pull-left">Copyright &copy; <a href="http://networkwe.com" target="_blank">NetworkWE</a> 2013</p>
            </footer>
        </div><!--/.fluid-container-->
        <?php
