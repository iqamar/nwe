			...
			<div class="right_top_wrap">
				<div class="findus-icons">
					<ul>
						...
						<li><a href="http://www.linkedin.com/company/networkwe" target="_blank" class="linkedin"></a></li>
						<li><a href="https://plus.google.com/+Networkwe" rel="publisher" target="_blank" class="gplus"></a></li>
 ...
 <?php
	...
	// echo $this->fetch('script');
        ...
        echo $this->Html->script(array(MEDIA_URL . '/js/jquery-1.10.2.min.js',
									   ...
									   //if(("home" == $this->params['controller']) && ("index" == $this->params['action'] || "myupdates" == $this->params['action'])){
