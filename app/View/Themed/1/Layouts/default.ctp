...
/*                $url = $this->here;
		 ...
		 $action = $this->params['action'];
                ...
                }  else if ($controller == 'users_profiles' || $controller == 'connections' || $controller == 'groups' || $controller == 'companies' || $controller == 'messages'|| $controller == 'blogs' || $controller == 'contacts') {
	...
	// echo $this->fetch('script');
        ...
        echo $this->Html->script(array(MEDIA_URL . '/js/jquery-1.10.2.min.js',
									  ...
									  // MEDIA_URL . '/js/datepicker/datepick-modules.js',
									   ...
									   }else if("news" == $this->params['controller']){ 
									   
										if("view" != $this->params['action']){
												echo $this->Html->script(array(MEDIA_URL.'/js/news_index.js',MEDIA_URL.'/js/jquery.validate.js'));
											}
									   }
