...
<div class="row-fluid sortable">
	...
	<div class="box-header well" data-original-title>
	    <h2><i class="icon-edit"></i> Add New Institutes</h2>
	    <div class="box-icon">
	...
	<div class="box-content"><br/>
		...
		<fieldset>
			...
			<div class="controls">
			    <input class="input-xlarge focused" id="selectInstitutes" name="selectInstitutes" type="text" value="">
			</div>
		    </div>
			...
			<div class="controls">
			    <input class="input-xlarge focused" id="established" name="established" type="text" value="">
			</div>
		    </div>
			...
			<div class="controls">
			    <input class="input-xlarge" id="primary_email" name="primary_email" type="text" value="">
			</div>
			<label class="control-label" for="alternative_email">Alternative Email</label>
			<div class="controls">
			    <input class="input-xlarge" id="alternative_email" name="alternative_email" type="text" value="">
			</div>
		    </div>
			...
			<div class="controls">
			    <input class="input-xlarge" id="featured_employer" name="featured_institute" type="checkbox" value="1">
			</div>
		    </div>
			...
			<div class="controls">
			    <input class="input-xlarge" id="top_institutes" name="top_institutes" type="checkbox" value="1">
			</div>
		    </div>
