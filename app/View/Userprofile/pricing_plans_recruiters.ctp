...
Reach top talent on NetworkWe
<a class="upgrades" href="/users/pricing_plans_jobseekers/" style="float:right;">Check Plans For Jobseekers &rarr;</a>
</h3>
...
<div class="plan_features">
        ...
        <ul>
            <li><b>Who's Viewed Your Profile &rarr;</b></li>
            <li><b>Full Network Visibility &rarr;</b></li>
            <li><b>InMail Messages &rarr;</b></li>
			<li><b>Premium Search &rarr;</b></li>	
			<li><b>Featured Applicant &rarr;</b></li>
			<li><b>Top Employer &rarr;</b></li>	
			<li><b>Chat Conversions with candiates &rarr;</b></li>	
			<li><b>Get Top Candiates &rarr;</b></li>		
        </ul> 
    ...
    <div class="plan">
        <h3>Free<span id="plan_1">$0</span></h3>
          <a class="signup" href="#loginmodal" id="plan_1_top" onclick="javascript:current_plan=1;">Sign up</a>       
        <ul>
            <li>Limited</li>
            <li>&nbsp;</li>
           <li>&nbsp;</li>
...
<li>&nbsp;</li> 
		...
		<a class="signup" href="#loginmodal" id="plan_1_bottom" onclick="javascript:current_plan=1;">Sign up</a> 
    </div >
    <div class="plan" >
        <h3>Basic<span id="plan_2">$800</span></h3>
         <a class="signup" href="#loginmodal" id="plan_2_top" onclick="javascript:current_plan=2;">Sign up</a>            
        <ul>
            <li>Yes</li>
            <li>&nbsp;</li>
           	<li>10 per month</li>
 		...
 		<a class="signup" href="#loginmodal" id="plan_2_bottom" onclick="javascript:current_plan=2;">Sign up</a> 
    </div>
    <div class="plan" id="most-popular">
        <h3>Plus<span id="plan_3">$1000</span></h3>
		<a class="signup" href="#loginmodal" id="plan_3_top" onclick="javascript:current_plan=3;">Sign up</a>  
        <ul>
            <li>Yes</li>
            <li>Yes</li>
           	<li>25 per month</li>
 		...
 		<a class="signup" href="#loginmodal" id="plan_3_bottom" onclick="javascript:current_plan=3;">Sign up</a>
    </div>
    <div class="plan">
        <h3>Elite<span id="plan_4">$1200</span></h3>
        <a class="signup" href="#loginmodal" id="plan_4_top" onclick="javascript:current_plan=4;">Sign up</a> 		
        <ul>
            <li>Yes</li>
            <li>Yes</li>
           	<li>50 per month</li>
 		...
 		<a class="signup" href="#loginmodal" id="plan_4_bottom" onclick="javascript:current_plan=4;">Sign up</a>
    </div> 	
</div>	   
...
$(function(){
 ...
 $('#registerform').submit(function(e){
	...
	$.ajax({
				...
				success: function(result){
					if(result==1){
						document.location = "/users/pricing_recruiters_registered";
					}else{
...
function changePrices(){
		if(currentPriceMode == "m"){
			...
			document.getElementById("plan_2").innerHTML="$8160";
			document.getElementById("plan_3").innerHTML="$9600";
			document.getElementById("plan_4").innerHTML="$10800";
			currentPriceMode = "y";
			...
			document.getElementById("plan_2").innerHTML="$800";
			document.getElementById("plan_3").innerHTML="$1000";
			document.getElementById("plan_4").innerHTML="$1200";
			currentPriceMode = "m";
		}
}
