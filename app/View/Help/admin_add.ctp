...
<div class="row-fluid sortable">
	...
	<div class="box-header well" data-original-title>
	    <h2><i class="icon-edit"></i>Add Help/FAQ</h2>
	    <div class="box-icon">
	...
	<div class="box-content"><br/>
		...
		<fieldset>
			...
			<label class="control-label" for="article">Help/FAQ Topic</label>
			<div class="controls">
			    <input class="input-xlarge focused" id="selectComapny" name="article" type="text" value="">
			</div>
		    </div>
