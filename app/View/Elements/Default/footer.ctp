<div class="footer">
    <a href="<?= $this->request->base ?>/the-company/aboutus/">About NetworkWe</a>   |   
    <a href="<?= $this->request->base ?>/the-company/team/">Meet Our Team</a>   |    
    <a href="<?= $this->request->base ?>/the-company/what/">What's NetworkWe?</a>   |  
    <a href="<?= $this->request->base ?>/the-company/why/">Why NetworkWe?</a>   |
    <a href="<?= $this->request->base ?>/the-company/contactus/">Contact Us</a> | 
<!--    <a href="#">Help Center</a>  | -->
    <a href="<?= $this->request->base ?>/the-company/joinus/">Career</a>
