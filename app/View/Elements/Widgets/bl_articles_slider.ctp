...
<div class="article_section_heading">
	<?php echo $this->Html->link('See more',array('controller'=>'news','action'=>'index'),array('escape'=>false,'class'=>'current seemore-tag'));?>
	<div class="article_section_heading">
	...
	<div class="slider-wrap-div">
		<div class="slider-wrap">
					...
					<div class="panel" title="Panel <?php echo $i;?>">
						<div class="">
							...
							<div class="article-rgt">
								...
								<div class="more"><?php echo $this->Html->link('more',array('controller'=>'news','action'=>'view',$newsId,$title_url),array('escape'=>false,'style'=>'color:#C70000;','class'=>'current'));?></div>
							</div>	
						</div>
					</div>
			...
			<?php $j=1; foreach ($postsSubmittedByUsers as $userNews) { 
				...
				<div>
					<a href="<?php echo NETWORKWE_URL.'/news/view/'.$newsId.'/'.$title_url;?>" class="current cross-link active-thumb">
