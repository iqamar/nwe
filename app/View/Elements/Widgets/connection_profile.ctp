...
<div class="location"><?php echo $user_Name['users_profiles']['address1']; if ($user_Name['users_profiles']['city']) {  echo " at ".$user_Name['users_profiles']['city'].", UAE"; }?></div>
...
<div class="tp-btn-pro">
		...
		<div style="margin-top:10px; box-shadow:1px 0px 10px 0px;">
			...
			?>
			<div class="expertize-left" style="width:150px;">
				<?php echo $this->Html->image('availability.png',array('style'=>'float:left;width:29px;margin-right:5px;margin-top:2px;'));?>
				<div style="width:115px;float:left;">
					<strong>Availabile for new challenges</strong>
                	
					<?php if ($user_Name['users_profiles']['avaliable'] == 'Available for hiring'){?>
					<p><?php echo $user_Name['users_profiles']['availability_type'];?></p>
					<?php } else {?>
					<p><?php echo $user_Name['users_profiles']['avaliable'];?></p>
					<?php }?>
            ...
            <div class="expertize-left">
				<?php echo $this->Html->image('intrested.png',array('style'=>'float:left;width:29px;margin-right:5px;;margin-top:2px;'));?>
                <strong>Intersted in</strong>
                <p><?php echo "Paid"; if ($user_Name['users_profiles']['intrested_in']) { echo ", ".$user_Name['users_profiles']['intrested_in']; }?></p>
            </div>
             <?php }?>
			<div class="expertize-left last-box">
                ...
                <p><?php if ($totalUserRequestedConnections) echo $totalUserRequestedConnections; else echo "0";?></p>
            </div>
                        ...
                        <div id="loadings" style="position:absolute; z-index:100px; left:50%; top:50%; text-align:center; display:none;"> 
                            ...
                            <?php 
                                ...
                                <?php if ($cgetuser['users_profiles']['photo']) {?>
									<a class="connection-photo" style="padding:5px;">
