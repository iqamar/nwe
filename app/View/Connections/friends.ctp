										...
										'<li>'.
											'<div style="display: block; float:right;"  id="notification-bttns">'.
                                               '<span id="response_102">'.
													'<a class="acceptbttn" href="javascript:invite_contacts('.$request["id"].',1,4)">Accept</a>'.
                                                '</span>'.
                                             '</div>'.
											  $request["tags"].
										'</li>'.
									...
									'<ul>'.
										...
										'<li>'.
											'<div class="listing-bttns">'. 
												'<a href="javascript:" onclick="remove_contact('.$invited["id"].','."'request'".',4)" class="poplight remove"/>Cancel Request</a>'.
											'</div>'.
											  $invited["tags"].
										'</li>'.
									'</ul>'.
