...
<?php if ($userInfo['users']['id']) {
				...
				?>
<?php }?>
<div class="tweets-user marginbottom15">
      <div class="mainuserdiv">
		  <div class="tweetsprofile-pic"> 
          <?php
        	if ($userName['photo']) {
				if (file_exists(MEDIA_PATH.'/files/user/thumbnail/'.$userName['photo'])) {
					echo $this->Html->Image(MEDIA_URL.'/files/user/thumbnail/'.$userName['photo'],array('url'=>array('controller'=>'tweets','action'=>'profile')));
				}
				else {
		...
		?>
				...
				<ul>
                  <li>
                    <h1><a href="/users_profiles/myprofile/"><?php echo $userName['firstname']." ".$userName['lastname'];?></a></h1>
                  </li>
                  <li>
                    <?php echo $userName['tags'];?>
                  </li>
	    		</ul>
       </div>   
      <div class="clear"></div> 
...
<div class="tweetactivities-div  marginbottom20 margintop30">
	 <a href="<?php echo NETWORKWE_URL;?>/tweets/index/">
      ...
      <a href="javascript:user_tweets('<?php echo $userID;?>')">
      <div class="tweets-user-activities">
	      <div class="activity-icon">
      ...
      <a href="javascript:user_following('<?php echo $userID;?>')">
      <div class="tweets-user-activities">
		    <div class="activity-icon">
      ...
      <a href="javascript:user_followers('<?php echo $userID;?>')">
      <div class="tweets-user-activities">
		    <div class="activity-icon">
            ...
            <div class="tweets-rgt">
                ...
                <?php $i =1; $flag = false;
						foreach ($tweets_retweeted_byUser as $retweet_users) {
							...
							if ($rettweet_content_id == $tweet_id) {
								if ($i<=3) {
										if ($i == 1) {
						...
						?>
                         <!--- Retweeted user box Starts Here --->
                    ...
                    <li><?php 
							...
							$output = trim($output);
							echo $output;
					//echo $tweet__Row['tweets']['tweet']?> </li>
                    <li>
                        ...
                        <ul>
                           ...
                           <li>
							...
							if ($tweet_admin == $uid) {
								...
								$distination = strtotime($tweet__Row['tweets']['modified']);
							}
                        ...
                        <div id="commentsDiv<?php echo $tweet_id;?>" style="display:none" class="replytweet">
                            <div class="writecomment">
                                ...
                                <div class="writecomment-rgt">
                                    <textarea id="tweet_reply_<?php echo $tweet_id;?>" name="data[Tweet][tweet_text]" onkeyup="countReply(this);" cols="" rows="" class="tweettextfield" onkeydown="checkField('<?php echo $tweet_id;?>')" placeholder="Post your reply"></textarea><br />
			...
			<div class="tweets" style="border:0px;">
						...
						<div class="tweets-rgt" style="width:88%;">
							<ul>
                                ...
                                <input type="hidden" name="actor_id" id="actor_id" value="<?php echo $userID;?>" />
       ...
       <div class="modal fade middlepopup" id="deleteupdatebox<?php echo $tweet_id;?>" tabindex="-1" role="dialog" aria-labelledby="deletebox" aria-hidden="true">
              <div class="modal-dialog modal-sm">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                   <button type="button" onclick="delete_tweet('<?php echo $tweet_id;?>','<?php echo $tweets_count_added_user;?>');" class="btn submitbttn" data-dismiss="modal">Yes</button>
                    <button type="button" class="btn canclebttn" data-dismiss="modal">No</button>
                  </div>
                </div>
              </div>
