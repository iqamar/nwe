  <?php foreach ($news_per_category as $news_inCat_Row) {
		...
		<div class="blogslisitng" id="<?php echo $newsId;?>">
			...
			<div class="blogslisitng-pic">
				...
				if ($news_inCat_Row['news']['image_url']) {
					...
					echo $this->Html->link($this->Html->Image(MEDIA_URL.'/files/news/logo/'.$news_inCat_Row['news']['image_url'],array()),'#',array('escape'=>false)); 
				} else {
