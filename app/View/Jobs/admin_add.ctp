...
<div class="control-group">
				...
				<div class="controls">
					...
					<option value="5">Moonlighting</option>
						...
						<label class="control-label">Job Type <span style="color:#FF0000;font-weight: 800;">*</span></label>
							<div class="controls">
								...
								<div style="box-shadow: 1px 1px 1px 1px; padding-top: 10px;">							  
									<label class="radio">	
									<input type="radio" name="job_type" id="employmentType1" value="1" checked="">
								...
								<div style="box-shadow: 1px 1px 1px 1px; padding-top: 10px;">	
									<label class="radio">							  
									<input type="radio" name="job_type" id="employmentType2" value="2" checked="">
								...
								<div style="box-shadow: 1px 1px 1px 1px; padding-top: 10px;">	
									<label class="radio">							  
									<input type="radio" name="job_type" id="employmentType3" value="3" checked="">
								...
								<div style="box-shadow: 1px 1px 1px 1px; padding-top: 10px;">
									<label class="radio">								  
									<input type="radio" name="job_type" id="employmentType4" value="4" checked="">
								...
								<div style="box-shadow: 1px 1px 1px 1px; padding-top: 10px;">	
									<label class="radio">							  
									<input type="radio" name="job_type" id="employmentType5" value="5" checked="">
								...
								<div style="box-shadow: 1px 1px 1px 1px; padding-top: 10px;">	
									<label class="radio">							  
                                                                            <input type="radio" name="job_type" id="employmentType6" value="6" checked="">
...
-->
			...
			<div class="controls">
				...
				<?php endforeach; ?>
			    </select> <input type="text" id="city" name="city" style="width:150px;margin-top: -20px;" placeholder="city" >
			</div>
		    </div>
			...
			<div class="controls">
			    <input style="width:125px;" type="text" class="input-xlarge datepicker" id="startDate" name="startDate" value="Choose Start Date" readonly>
				&nbsp;&nbsp;&nbsp;
				<input style="width:125px;" type="text" class="input-xlarge datepicker" id="expiryDate" name="expiryDate" value="Choose End Date" readonly>
			</div>
		    </div>
...
<div class="control-group">
			<label class="control-label" for="job_description">Job Description <span style="color:#FF0000;font-weight: 800;">*</span></label>
		   		   ...
		   		   <div class="controls">
			    <textarea class="cleditor" id="jobDescription" name="job_description" rows="3"></textarea>
			</div>
		    </div>
...
The [COMPANY_NAME] team
			...
			<div class="controls">
			    <input class="input-xlarge focused" id="conatctPerson" name="contactPerson" type="text" value="">
			</div>
		    </div>
			...
			<div class="controls">
			    <input class="input-xlarge focused" id="contactNumber" name="contactNumber" type="text" value="">
			</div>
		    </div>
