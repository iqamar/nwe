	...
	<div class="progress progress-info progress-striped" style="width:60%;">
		...
		<li><a href="#step_5" id="job_step_5">Contact Information</a></li>					
		 ...
		 <div id="jobTabContent" class="tab-content">
 			<?php echo $this->element('Jobs/add_step_1'); ?>
		    <?php echo $this->element('Jobs/add_step_2'); ?>
			<?php echo $this->element('Jobs/add_step_3'); ?>
			<?php echo $this->element('Jobs/add_step_4'); ?>
			<?php echo $this->element('Jobs/add_step_5'); ?>
		 </div>
