...
*******************************************************************************
Revised Version: 1.1
Ported to CakePHP component 11/20/10 by http://www.immortalwolf.com
	- added cURL call function into component<br />
Updated 1/13/11
	- fixed set_callback method for usage in CakePHP
Maintained: http://www.immortalwolf.com/code-repository/cakephp-components
*******************************************************************************/
...
class simple_html_dom_node {
    ...
    function outertext() {
        ...
        // trigger callback
        if ($this->dom->callbackToRun!==null)
                call_user_func_array(array($this->dom->objectToUse,$this->dom->callbackToRun),array($this));
...
// -----------------------------------------------------------------------------
class SimpleHtmlDomBakedComponent extends Object {
	
    public $root = null;
    public $nodes = array();
    public $objectToUse = null;
    public $callbackToRun = null;
	...
	function curl_and_load($url, $lowercase=true){
		$ch = curl_init($url);
    ...
    function set_callback($obj, $function_name) {
        $this->objectToUse = $obj;
        $this->callbackToRun = $function_name;
    }

    // remove callback function
    function remove_callback() {
        $this->objectToUse = null;
        $this->callbackToRun = null;
    }
