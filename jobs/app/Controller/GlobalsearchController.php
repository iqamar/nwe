        ...
        if (isset($this->request->data)) {
            ...
            switch ($SearchScope) {
                ...
                case 4 : 
                    ...
                    $this->paginate = array('fields' => array('Group.id,Group.title,groups_types.title'),'conditions' => $conditionsGroups, 'limit' => $limit);
                ...
                default : 
                    ...
                    $this->Users_profile->recursive = 2;
					$dataUser = $this->Users_profile->find('all', array('fields' => array('Users_profile.firstname,Users_profile.id,Users_profile.user_id,Users_profile.photo,CONCAT(Users_profile.firstname, " ", Users_profile.lastname) AS fullname,Users_profile.gender,User.id,User.role_id,User.status'),'conditions' => $conditionsUsersProfiles,'order' => 'fullname asc', 'limit' => $limit, 'offset' => $offset));
    ...
    function auto_suggest($limit = 4, $offset = 0) {
        ...
        switch ($SearchScope) {
            case 1 : 
                ...
                $conditionsUsersProfiles = array_merge($conditionsUsersProfiles, array('AND' => array($cond)));
                $this->Users_profile->recursive = 2;
				$dataUser = $this->Users_profile->find('all', array('fields' => array('Users_profile.firstname,Users_profile.user_id,Users_profile.photo,CONCAT(Users_profile.firstname, " ", Users_profile.lastname) AS fullname,User.id,User.role_id,User.status'), 'conditions' => $conditionsUsersProfiles,'order' => 'fullname asc', 'limit' => $limit, 'offset' => $offset));
                $this->set('datauser', $dataUser);
                break;
            case 2 : 
                $cond[$i++] = array('AND' => array('Job.status ' => '2'));
