            ...
            <div class="topsearch">
                <table width="200" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td>
<?php echo $this->Form->input('location',array('type'=>'select','options'=>array(''=>'In All Locations',$countryList),'default' => 0,'id'=>'location','class'=>'','style'=>'width:145px;padding:6px;margin:2px;','label'=>false,'div'=>false)); ?>
