...
<div class="box">
	<div class="boxheading">
		<h1>Jobs In <?php echo  $ftitle['functional_area']['title']; ?></h1>
	...
	<?php 
		...
		foreach($jobsby as $row){
			...
			$listing.="<ul><li><h1>".$this->Html->link($row['Job']['title'],array('controller'=>'search','action'=>'jobDetails/'.$row['Job']['id'].'/'.$row['Job']['title']),array('class'=>'current','escape'=>false))."</h1></li>";
