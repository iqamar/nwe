// Nice Tooltip Script Starts Here //
var tooltipOptions=
{
    showDelay: 100,
    hideDelay: 300,
...
// Sliding Tab Script  Ends // 
$(window).load(function () {
        $(".demo").customScrollbar({preventDefaultScroll: true});
        $(".fixed-thumb-size-demo").customScrollbar({fixedThumbHeight: 100, fixedThumbWidth: 60});
 });
...
$(document).ready(function(){
	$(window).load(function(){
	$("#mixnotification .has-sub ul").css("display", "none");
	$("#mixnotification").mouseover(function(){
            /*
             * Fix for notificatoin when empty, display:none not suitable.
             */
            $("#mixnotification ul li.has-sub ul").css("visibility","visible");
		$("#mixnotification .has-sub ul").show();
                
		});
	$("#mixnotification .has-sub ul, #mixnotification").mouseleave(function(){
		$("#mixnotification .has-sub ul").hide();
	});
});
});				
...
$(document).ready(function(){
	$(window).load(function(){
	$("#message .has-sub ul").css("display", "none");
	$("#message").mouseover(function(){
            /*
             * Fix for notificatoin when empty, display:none not suitable.
             */
            $("#message ul li.has-sub ul").css("visibility","visible");
		$("#message .has-sub ul").show();
                
		});
	$("#message .has-sub ul, #message").mouseleave(function(){
		$("#message .has-sub ul").hide();
	});
});
});				